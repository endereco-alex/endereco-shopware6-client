...
**Description:** Automatically downloads Shopware production releases (6.7.0.1, 6.7.1.2, 6.7.2.2, ..., 6.7.10.2) from GitHub and extracts them into the `shops/` directory.
